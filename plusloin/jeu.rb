class Personne
  ...
  def subit_attaque(degats_recus)
    ...
    puts "#{nom} subit #{degats_recus} degats"
    # A faire:
...
class Joueur < Personne
  ...
  def soin
    amount = 50
    @points_de_vie = @points_de_vie + amount
    puts "#{nom} se soigne et gagne #{amount}PV."
  end

  def ameliorer_degats
    @degats_bonus += 20
    puts "#{nom} se concentre ce tour."
  end
end
